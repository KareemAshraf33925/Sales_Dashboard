  ...
  return (
    <div className='shadow-xl p-8 rounded-2xl my-2 w-full lg:w-1/2'>
        ...
        <div className='flex justify-center items-center gap-5  '>
            <img src="/assets/jars.svg" alt="jars" className='w-8 h-8' />
        ...
        <div className='flex justify-center items-center gap-5 '>
            <img src="/assets/html.png" alt="html" className='w-8 h-8' />
            <div>
            ...
            <div className='flex justify-center items-center gap-5 '>
            <img src="/assets/basket.png" alt="basket" className='w-8 h-8' />
            <div>
            ...
            <div className='flex justify-center items-center gap-5 '>
            <img src="/assets/card.png" alt="card" className='w-8 h-8' />
            <div>
            ...
            <div className='flex justify-center items-center gap-5 '>
            <img src="/assets/key.png" alt="key" className='w-8 h-8' />
            <div>
            ...
            <div className='flex justify-center items-center gap-5 '>
            <img src="/assets/order.png" alt="order" className='w-8 h-8' />
            <div>
